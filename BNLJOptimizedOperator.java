     ...
     private class BNLJOptimizedIterator extends JoinIterator {
        ...
        private void fetchNextLeftPage() throws DatabaseException {
        	if (this.leftSourceIterator.hasNext()) {
        		this.leftRecordPerPageIterator = BNLJOptimizedOperator.this.getBlockIterator(this.getLeftTableName(), this.leftSourceIterator, numBuffers - 2);
        		
        		while (!this.leftRecordPerPageIterator.hasNext()) {
        			try {
        				this.leftRecordPerPageIterator = BNLJOptimizedOperator.this.getBlockIterator(this.getLeftTableName(), this.leftSourceIterator);
        ...
        private void fetchNextRightPage() throws DatabaseException {
        	if (this.rightSourceIterator.hasNext()) {
        		this.rightRecordPerPageIterator = BNLJOptimizedOperator.this.getBlockIterator(this.getRightTableName(), this.rightSourceIterator, 1);
