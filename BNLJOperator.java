    ...
    private class BNLJIterator extends JoinIterator {
        ...
        private void fetchNextLeftPage() throws DatabaseException {
        	if (this.leftSourceIterator.hasNext()) {
        		this.leftRecordPerPageIterator = BNLJOperator.this.getBlockIterator(this.getLeftTableName(), this.leftSourceIterator, 1);
        		
        		while (!this.leftRecordPerPageIterator.hasNext()) {
        			try {
        				this.leftRecordPerPageIterator = BNLJOperator.this.getBlockIterator(this.getLeftTableName(), this.leftSourceIterator);
        			} catch (NoSuchElementException e) {
        				this.leftSourceIterator = null;
        				this.leftRecord = null;
        				throw new NoSuchElementException();
        			}
        		}
        		
        		this.leftRecord = this.leftRecordPerPageIterator.next();
        ...
        private void fetchNextRightPage() throws DatabaseException {
        	if (this.rightSourceIterator.hasNext()) {
        		this.rightRecordPerPageIterator = BNLJOperator.this.getBlockIterator(this.getRightTableName(), this.rightSourceIterator, 1);

        		while (!this.rightRecordPerPageIterator.hasNext()) {
            		try {
                    	this.rightRecordPerPageIterator = BNLJOperator.this.getBlockIterator(this.getRightTableName(), this.rightSourceIterator);
            		} catch (NoSuchElementException e) {
        				this.rightSourceIterator = null;
        				throw new NoSuchElementException();
        			} 
            	}
        	...
        	if (this.leftRecord != null) {
        		...
        		try {       
            		while (nextRecord == null) {
            			if (this.rightRecordPerPageIterator != null && this.rightRecordPerPageIterator.hasNext()) {
            			...
            			} else if (this.leftRecordPerPageIterator.hasNext()) {
            				this.leftRecord = this.leftRecordPerPageIterator.next();
            				this.rightRecordPerPageIterator.reset();
            			} else if (this.rightSourceIterator.hasNext()) {
            				this.fetchNextRightPage();
            				this.leftRecordPerPageIterator.reset();
            				this.leftRecord = this.leftRecordPerPageIterator.next();
            				} else {
            				this.fetchNextLeftPage();
            				this.rightSourceIterator.reset();
